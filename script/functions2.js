...
document.getElementById('create-form').addEventListener('change',()=>{
  ...
  if((posterElement.files.length) &&
     (gameTitleElement.value) &&
...
function searchData(){
  ...
  if(search.length != 0 && search[0] != " "){
      ...
      http.open("GET", "loadSearch.php?q=" + search, true);
      http.send();
...
function clicked(e){
  let gameTitle = e;
    ...
    http.open("GET", "getResult.php?q=" + gameTitle, true);
    http.send();
